//! Octoscript (Makepad Script) integration — the `d3.*` widget namespace
//!
//! This module makes makepad-d3 charts directly usable from the Octoscript DSL.
