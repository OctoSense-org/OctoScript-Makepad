...
- `~/.cargo/git/checkouts/makepad-721ba110953b28bc/53b2e5c/draw/src/shader/draw_text.rs` - DrawText implementation
- `~/.cargo/git/checkouts/makepad-721ba110953b28bc/53b2e5c/draw/src/text/geom.rs` - Transform utilities (no rotation)
- `~/.cargo/git/checkouts/makepad-721ba110953b28bc/53b2e5c/widgets/src/rotated_image.rs` - Reference for rotation pattern
- `~/.cargo/git/checkouts/makepad-721ba110953b28bc/53b2e5c/draw/src/draw_list_2d.rs` - View transform (list-level, not per-glyph)
