//! octoscript-widgets — themed native-widget kits for makepad, defined as **external**
...
//! drawn by their own MPSL shaders; their look is *not* reachable from the Octoscript
...
//! re-points the prelude (what a mounted Octoscript body resolves) at them.
//!
