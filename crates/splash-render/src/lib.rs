...
mod tests {
    ...
    fn navigation_controls_resolve_all_helpers() {
        let source = [
            include_str!("../../../components/l0/_palette_dark.splash"),
            include_str!("../../../components/l0/_derive.splash"),
            include_str!("../../../components/l0/_kit.splash"),
...
mod boundary_tests {
    ...
    fn depth_and_width_limits_return_complete_trees_or_failure() {
        ...
        assert!(build(&nested(splash_node::MAX_TREE_DEPTH + 1), |_| {}).is_none());
