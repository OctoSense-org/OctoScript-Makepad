//! The Octoscript UI node model — the branch point.
//!
...
//! nothing at all. `octoscript-render` evaluates the DSL and needs a VM; a host that
...
//!
//! So the division is: **this crate is the contract, `octoscript-render` is one way
